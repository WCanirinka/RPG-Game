...
export default class CreditsScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.madeByText = this.add.text(
      0,
      0,
      'African-Jungle build by Wilfried Canirinka',
      { fontSize: '26px', fill: '#B09B1C' },
    );
    this.explain1 = this.add.text(
      0,
      0,
      'This a game is built as a demonstration of mastery in a Capstone project ',
      { fontSize: '26px', fill: '#fff' },
    );
    this.explain2 = this.add.text(
      0,
      0,
      'using JavaScript for the JavaScript section in Microverse program.',
      { fontSize: '26px', fill: '#fff' },
    );
